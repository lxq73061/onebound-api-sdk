...
class item_dangdang extends item_base{
	...
	function big2small_pic($url,$width,$height=0){
		...
		$size = 'k';
		switch($width){
			case $width>500:$size='u';break;
			case $width>400:$size='e';break;
			case $width>350:$size='k';break;
			case $width>300:$size='w';break;
			case $width>200:$size='h';break;
			case $width>150:$size='b';break;
			case $width>120:$size='l';break;
			case $width>100:$size='m';break;
			case $width>90:$size='s';break;
			case $width>70:$size='p';break;
			case $width>54:$size='t';break;
			case $width>45:$size='x';break;
			default: $size = 'v';
		}
